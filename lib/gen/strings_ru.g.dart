...
class _TranslationsTermOfServicePrivacyPolicyRu implements TranslationsTermOfServicePrivacyPolicyEn {
	...
	@override String get section3Body => 'Ваши данные обрабатываются для отслеживания прогресса обучения, персонализации словарного контента и устранения технических проблем. Личная информация никогда не продается и не передается третьим лицам для коммерческого использования. Надежные поставщики услуг (облачное хранилище, аутентификация и управление подписками) обрабатывают данные строго в соответствии со своими обязательствами по конфиденциальности.';
...
class _TranslationsTermOfServiceCookiePolicyRu implements TranslationsTermOfServiceCookiePolicyEn {
	...
	@override String get lastUpdated => 'Последнее обновление: 2026';
	@override String get intro => 'Добро пожаловать в Lingola Kids. Технологии цифровых помощников используются для того, чтобы сделать ваш опыт видеозвонков с ИИ более плавным, безопасным и персонализированным.';
	...
	@override String get section4Body => 'Некоторые технологии могут предоставляться поставщиками технических услуг и подпадают под их собственную политику. Lingola Kids уделяет первостепенное внимание безопасности данных в этих партнерствах.';
...
class _TranslationsOnboardingStep5Ru implements TranslationsOnboardingStep5En {
	...
	@override String get permission1Subtitle => 'Lingola Kids использует вашу камереру для видеозвонков с ИИ-персонажами.';
	@override String get permission2 => 'Доступ к микрофону';
	@override String get permission2Subtitle => 'Lingola Kids использует ваш микрофон для голосовых и видеозвонков.';
	@override String get permission3 => 'Доступ к местоположению';
	@override String get permission3Subtitle => 'Lingola Kids использует ваше местоположение для персонализации вашего опыта.';
}
...
class _TranslationsDeleteAccountStepsStep1Ru implements TranslationsDeleteAccountStepsStep1En {
	...
	@override String get subtitle => 'Не могли бы вы сказать нам, почему вы хотите уйти, чтобы мы могли улучшить Lingola Kids?';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'termOfService.cookiePolicy.intro' => 'Добро пожаловать в Lingola Kids. Технологии цифровых помощников используются для того, чтобы сделать ваш опыт видеозвонков с ИИ более плавным, безопасным и персонализированным.',
			...
			'termOfService.cookiePolicy.section4Body' => 'Некоторые технологии могут предоставляться поставщиками технических услуг и подпадают под их собственную политику. Lingola Kids уделяет первостепенное внимание безопасности данных в этих партнерствах.',
			...
			'onboarding.step5.permission1Subtitle' => 'Lingola Kids использует вашу камереру для видеозвонков с ИИ-персонажами.',
			'onboarding.step5.permission2' => 'Доступ к микрофону',
			'onboarding.step5.permission2Subtitle' => 'Lingola Kids использует ваш микрофон для голосовых и видеозвонков.',
			'onboarding.step5.permission3' => 'Доступ к местоположению',
			'onboarding.step5.permission3Subtitle' => 'Lingola Kids использует ваше местоположение для персонализации вашего опыта.',
			...
			'deleteAccount.steps.step1.subtitle' => 'Не могли бы вы сказать нам, почему вы хотите уйти, чтобы мы могли улучшить Lingola Kids?',
