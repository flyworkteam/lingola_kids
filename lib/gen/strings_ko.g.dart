...
class _TranslationsTermOfServicePrivacyPolicyKo implements TranslationsTermOfServicePrivacyPolicyEn {
	...
	@override String get section3Body => '귀하의 데이터는 학습 진행 상황을 추적하고, 어휘 콘텐츠를 맞춤 설정하고, 기술적 문제를 해결하기 위해 처리됩니다. 개인정보는 영리 목적으로 제3자에게 판매되거나 공유되지 않습니다. 신뢰할 수 있는 서비스 제공업체(클라우드 스토리지, 인증 및 구독 관리)는 기밀 유지 의무 하에 데이터를 엄격하게 처리합니다.';
...
class _TranslationsTermOfServiceCookiePolicyKo implements TranslationsTermOfServiceCookiePolicyEn {
	...
	@override String get lastUpdated => '최종 업데이트: 2026';
	@override String get intro => 'Lingola Kids에 오신 것을 환영합니다. 디지털 도우미 기술은 AI 영상 통화 경험을 더욱 원활하고 안전하며 개인화되도록 만드는 데 사용됩니다.';
	...
	@override String get section4Body => '일부 기술은 기술 서비스 제공업체에서 제공할 수 있으며 자체 정책의 적용을 받습니다. Lingola Kids는 이러한 파트너십에서 데이터 보안을 우선시합니다.';
...
class _TranslationsOnboardingStep5Ko implements TranslationsOnboardingStep5En {
	...
	@override String get permission1Subtitle => 'Lingola Kids는 AI 캐릭터와의 영상 통화를 위해 카메라를 사용합니다.';
	@override String get permission2 => '마이크 접근 권한';
	@override String get permission2Subtitle => 'Lingola Kids는 음성 및 영상 통화를 위해 마이크를 사용합니다.';
	@override String get permission3 => '위치 접근 권한';
	@override String get permission3Subtitle => 'Lingola Kids는 사용자의 경험을 개인화하기 위해 위치를 사용합니다.';
}
...
class _TranslationsDeleteAccountStepsStep1Ko implements TranslationsDeleteAccountStepsStep1En {
	...
	@override String get subtitle => '떠나려는 이유를 알려주실 수 있나요? Lingola Kids를 개선하는 데 도움이 됩니다.';
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'termOfService.privacyPolicy.section3Body' => '귀하의 데이터는 학습 진행 상황을 추적하고, 어휘 콘텐츠를 맞춤 설정하고, 기술적 문제를 해결하기 위해 처리됩니다. 개인정보는 영리 목적으로 제3자에게 판매되거나 공유되지 않습니다. 신뢰할 수 있는 서비스 제공업체(클라우드 스토리지, 인증 및 구독 관리)는 기밀 유지 의무 하에 데이터를 엄격하게 처리합니다.',
			...
			'termOfService.cookiePolicy.intro' => 'Lingola Kids에 오신 것을 환영합니다. 디지털 도우미 기술은 AI 영상 통화 경험을 더욱 원활하고 안전하며 개인화되도록 만드는 데 사용됩니다.',
			...
			'termOfService.cookiePolicy.section4Body' => '일부 기술은 기술 서비스 제공업체에서 제공할 수 있으며 자체 정책의 적용을 받습니다. Lingola Kids는 이러한 파트너십에서 데이터 보안을 우선시합니다.',
			...
			'onboarding.step5.permission1Subtitle' => 'Lingola Kids는 AI 캐릭터와의 영상 통화를 위해 카메라를 사용합니다.',
			'onboarding.step5.permission2' => '마이크 접근 권한',
			'onboarding.step5.permission2Subtitle' => 'Lingola Kids는 음성 및 영상 통화를 위해 마이크를 사용합니다.',
			'onboarding.step5.permission3' => '위치 접근 권한',
			'onboarding.step5.permission3Subtitle' => 'Lingola Kids는 사용자의 경험을 개인화하기 위해 위치를 사용합니다.',
			...
			'deleteAccount.steps.step1.subtitle' => '떠나려는 이유를 알려주실 수 있나요? Lingola Kids를 개선하는 데 도움이 됩니다.',
