...
class _TranslationsParentalGateKo implements TranslationsParentalGateEn {
	...
	// Translations
	@override String get title => '보호자 전용';
	@override String get subtitle => '계속하려면 다음 수학 문제를 풀어주세요:';
	@override String get hint => '답변';
	@override String get incorrect => '정답이 아닙니다. 다시 시도해 주세요.';
}
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'parentalGate.title' => '보호자 전용',
			'parentalGate.subtitle' => '계속하려면 다음 수학 문제를 풀어주세요:',
			'parentalGate.hint' => '답변',
			'parentalGate.incorrect' => '정답이 아닙니다. 다시 시도해 주세요.',
			_ => null,
		};
	}
}
