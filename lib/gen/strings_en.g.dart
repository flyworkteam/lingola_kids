...
class TranslationsTermOfServiceCookiePolicyEn {
	...
	/// en: 'Welcome to Lingola Kids. Digital helper technologies are used to make your AI video call experience smoother, more secure, and personalized.'
	String get intro => 'Welcome to Lingola Kids. Digital helper technologies are used to make your AI video call experience smoother, more secure, and personalized.';
	...
	/// en: 'Some technologies may be provided by technical service providers and are subject to their own policies. Lingola Kids prioritizes data security in these partnerships.'
	String get section4Body => 'Some technologies may be provided by technical service providers and are subject to their own policies. Lingola Kids prioritizes data security in these partnerships.';
...
class TranslationsOnboardingStep5En {
	...
	/// en: 'Lingola Kids uses your camera for video calls with AI characters.'
	String get permission1Subtitle => 'Lingola Kids uses your camera for video calls with AI characters.';

	/// en: 'Microphone Access'
	String get permission2 => 'Microphone Access';

	/// en: 'Lingola Kids uses your microphone for voice and video calls.'
	String get permission2Subtitle => 'Lingola Kids uses your microphone for voice and video calls.';

	/// en: 'Location Access'
	String get permission3 => 'Location Access';

	/// en: 'Lingola Kids uses your location to personalize your experience.'
	String get permission3Subtitle => 'Lingola Kids uses your location to personalize your experience.';
}
...
class TranslationsDeleteAccountStepsStep1En {
	...
	/// en: 'Can you tell us why you want to leave so we can improve the Lingola Kids experience?'
	String get subtitle => 'Can you tell us why you want to leave so we can improve the Lingola Kids experience?';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'termOfService.cookiePolicy.intro' => 'Welcome to Lingola Kids. Digital helper technologies are used to make your AI video call experience smoother, more secure, and personalized.',
			...
			'termOfService.cookiePolicy.section4Body' => 'Some technologies may be provided by technical service providers and are subject to their own policies. Lingola Kids prioritizes data security in these partnerships.',
			...
			'onboarding.step5.permission1Subtitle' => 'Lingola Kids uses your camera for video calls with AI characters.',
			'onboarding.step5.permission2' => 'Microphone Access',
			'onboarding.step5.permission2Subtitle' => 'Lingola Kids uses your microphone for voice and video calls.',
			'onboarding.step5.permission3' => 'Location Access',
			'onboarding.step5.permission3Subtitle' => 'Lingola Kids uses your location to personalize your experience.',
			...
			'deleteAccount.steps.step1.subtitle' => 'Can you tell us why you want to leave so we can improve the Lingola Kids experience?',
