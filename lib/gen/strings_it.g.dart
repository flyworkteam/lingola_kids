...
class TranslationsIt with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String continue_to({required Object language}) => 'Continua in ${language}';
...
class _TranslationsStoriesIt implements TranslationsStoriesEn {
	...
	@override late final _TranslationsStoriesCategoriesIt categories = _TranslationsStoriesCategoriesIt._(_root);
}
...
class _TranslationsLibraryIt implements TranslationsLibraryEn {
	...
	@override String get noWordsFound => 'Nessuna parola trovata';
	@override String get noSavedWords => 'Nessuna parola salvata ancora';
}
...
class _TranslationsParentalGateIt implements TranslationsParentalGateEn {
	...
	// Translations
	@override String get title => 'Solo per genitori';
	@override String get subtitle => 'Per favore risolvi il seguente problema matematico per continuare:';
	@override String get hint => 'Risposta';
	@override String get incorrect => 'Risposta errata, riprova per favore.';
}
...
class _TranslationsOnboardingStep1It implements TranslationsOnboardingStep1En {
	...
	// Translations
	@override String get title => 'In quale lingua vuoi tradurre l\'inglese per impararlo?';
	@override String get subtitle => 'Per favore seleziona la lingua in cui desideri imparare l\'inglese traducendolo.';
}
...
class _TranslationsStoriesCategoriesIt implements TranslationsStoriesCategoriesEn {
	_TranslationsStoriesCategoriesIt._(this._root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get popular => 'Popolari';
	@override String get space => 'Spazio';
	@override String get magic => 'Magia';
	@override String get animals => 'Animali';
	@override String get detectives => 'Detective';
	@override String get dinosaurs => 'Dinosauri';
	@override String get superhero => 'Supereroi';
	@override String get underwater => 'Sottomarino';
	@override String get fairytale => 'Fiabe';
}
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'continue_to' => ({required Object language}) => 'Continua in ${language}',
			'get_started' => 'Inizia',
			'next' => 'Avanti',
			'back' => 'Indietro',
			'skip' => 'Salta',
			...
			'onboarding.step1.title' => 'In quale lingua vuoi tradurre l\'inglese per impararlo?',
			'onboarding.step1.subtitle' => 'Per favore seleziona la lingua in cui desideri imparare l\'inglese traducendolo.',
			...
			'stories.categories.popular' => 'Popolari',
			'stories.categories.space' => 'Spazio',
			'stories.categories.magic' => 'Magia',
			'stories.categories.animals' => 'Animali',
			'stories.categories.detectives' => 'Detective',
			'stories.categories.dinosaurs' => 'Dinosauri',
			'stories.categories.superhero' => 'Supereroi',
			'stories.categories.underwater' => 'Sottomarino',
			'stories.categories.fairytale' => 'Fiabe',
			...
			'library.noWordsFound' => 'Nessuna parola trovata',
			'library.noSavedWords' => 'Nessuna parola salvata ancora',
			'bottomNav.home' => 'Home',
			...
			'parentalGate.title' => 'Solo per genitori',
			'parentalGate.subtitle' => 'Per favore risolvi il seguente problema matematico per continuare:',
			'parentalGate.hint' => 'Risposta',
			'parentalGate.incorrect' => 'Risposta errata, riprova per favore.',
			_ => null,
		};
	}
}
