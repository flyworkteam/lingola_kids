...
class TranslationsIt with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsVoicePlaybackIt voicePlayback = _TranslationsVoicePlaybackIt._(_root);
	@override late final _TranslationsLocalNotificationsIt localNotifications = _TranslationsLocalNotificationsIt._(_root);
...
// Path: voicePlayback
class _TranslationsVoicePlaybackIt implements TranslationsVoicePlaybackEn {
	_TranslationsVoicePlaybackIt._(this._root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get loading => 'Audio in caricamento...';
	@override String get playing => 'Audio pronto, riproduzione in corso.';
	@override String get missing => 'Audio non trovato. Riprova.';
	@override String get failed => 'Impossibile preparare l\'audio. Riprova.';
}

// Path: localNotifications
class _TranslationsLocalNotificationsIt implements TranslationsLocalNotificationsEn {
	_TranslationsLocalNotificationsIt._(this._root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get channelName => 'Promemoria giornalieri di apprendimento';
	@override String get channelDescription => 'Promemoria che aiutano i bambini a mantenere la loro serie giornaliera di apprendimento.';
	@override String get reminderTitle => 'Lingola Kids';
	@override String get reminderBody => 'Mantieni la tua serie con una lezione veloce oggi.';
	@override String get debugTitle => 'Lingola Kids';
	@override String get debugBody => 'Le notifiche locali funzionano.';
}
...
class _TranslationsHomeIt implements TranslationsHomeEn {
	...
	@override String get streakTitle => 'Stato della serie';
	@override String streakActive({required Object count}) => 'Al momento hai una serie di apprendimento di ${count} giorni. Completa una lezione ogni giorno per mantenerla.';
	@override String get streakEmpty => 'La tua serie di apprendimento non è ancora iniziata. Completa una lezione oggi per iniziarla.';
...
class _TranslationsProfileScreenIt implements TranslationsProfileScreenEn {
	...
	@override String get upgradeToPro => 'Passa a Pro';
	@override String get upgradeToProSubtitle => 'Sblocca tutte le lezioni e le funzioni';
	...
	@override String get trialSubscriptionTitle => 'Prova Premium Attiva';
	@override String get trialSubscriptionPrompt => 'Stai utilizzando attualmente un abbonamento di prova premium. Vuoi iscriverti?';
...
class _TranslationsParentalGateIt implements TranslationsParentalGateEn {
	...
	@override String get wrongAnswer => 'Risposta sbagliata. Per favore riprova.';
...
class _TranslationsTermOfServiceCookiePolicyIt implements TranslationsTermOfServiceCookiePolicyEn {
	...
	@override String get lastUpdated => 'Ultimo aggiornamento: 2026';
	@override String get intro => 'Benvenuti in Lingola Kids. Le tecnologie di supporto digitale vengono utilizzate per rendere la tua esperienza di videochiamata AI più fluida, sicura e personalizzata.';
	...
	@override String get section4Body => 'Alcune tecnologie potrebbero essere fornite da fornitori di servizi tecnici e sono soggette alle loro politiche. Lingola Kids dà priorità alla sicurezza dei dati in queste partnership.';
...
class _TranslationsOnboardingStep5It implements TranslationsOnboardingStep5En {
	...
	@override String get permission1Subtitle => 'Lingola Kids utilizza la tua fotocamera per videochiamate con personaggi AI.';
	@override String get permission2 => 'Accesso al microfono';
	@override String get permission2Subtitle => 'Lingola Kids utilizza il tuo microfono per le chiamate vocali e le videochiamate.';
	@override String get permission3 => 'Accesso alla posizione';
	@override String get permission3Subtitle => 'Lingola Kids utilizza la tua posizione per personalizzare la tua esperienza.';
}
...
class _TranslationsDeleteAccountStepsStep1It implements TranslationsDeleteAccountStepsStep1En {
	...
	@override String get subtitle => 'Puoi dirci perché vuoi andartene così possiamo migliorare l\'esperienza di Lingola Kids?';
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'ok' => 'OK',
			'voicePlayback.loading' => 'Audio in caricamento...',
			'voicePlayback.playing' => 'Audio pronto, riproduzione in corso.',
			'voicePlayback.missing' => 'Audio non trovato. Riprova.',
			'voicePlayback.failed' => 'Impossibile preparare l\'audio. Riprova.',
			'localNotifications.channelName' => 'Promemoria giornalieri di apprendimento',
			'localNotifications.channelDescription' => 'Promemoria che aiutano i bambini a mantenere la loro serie giornaliera di apprendimento.',
			'localNotifications.reminderTitle' => 'Lingola Kids',
			'localNotifications.reminderBody' => 'Mantieni la tua serie con una lezione veloce oggi.',
			'localNotifications.debugTitle' => 'Lingola Kids',
			'localNotifications.debugBody' => 'Le notifiche locali funzionano.',
			...
			'termOfService.cookiePolicy.intro' => 'Benvenuti in Lingola Kids. Le tecnologie di supporto digitale vengono utilizzate per rendere la tua esperienza di videochiamata AI più fluida, sicura e personalizzata.',
			...
			'termOfService.cookiePolicy.section4Body' => 'Alcune tecnologie potrebbero essere fornite da fornitori di servizi tecnici e sono soggette alle loro politiche. Lingola Kids dà priorità alla sicurezza dei dati in queste partnership.',
			...
			'onboarding.step5.permission1Subtitle' => 'Lingola Kids utilizza la tua fotocamera per videochiamate con personaggi AI.',
			'onboarding.step5.permission2' => 'Accesso al microfono',
			'onboarding.step5.permission2Subtitle' => 'Lingola Kids utilizza il tuo microfono per le chiamate vocali e le videochiamate.',
			'onboarding.step5.permission3' => 'Accesso alla posizione',
			'onboarding.step5.permission3Subtitle' => 'Lingola Kids utilizza la tua posizione per personalizzare la tua esperienza.',
			...
			'home.streakTitle' => 'Stato della serie',
			'home.streakActive' => ({required Object count}) => 'Al momento hai una serie di apprendimento di ${count} giorni. Completa una lezione ogni giorno per mantenerla.',
			'home.streakEmpty' => 'La tua serie di apprendimento non è ancora iniziata. Completa una lezione oggi per iniziarla.',
			'home.weekDays.0' => 'LUN',
			'home.weekDays.1' => 'MAR',
			'home.weekDays.2' => 'MER',
			'home.weekDays.3' => 'GIO',
			...
			'deleteAccount.steps.step1.subtitle' => 'Puoi dirci perché vuoi andartene così possiamo migliorare l\'esperienza di Lingola Kids?',
			...
			'profileScreen.upgradeToPro' => 'Passa a Pro',
			'profileScreen.upgradeToProSubtitle' => 'Sblocca tutte le lezioni e le funzioni',
			...
			'profileScreen.trialSubscriptionTitle' => 'Prova Premium Attiva',
			'profileScreen.trialSubscriptionPrompt' => 'Stai utilizzando attualmente un abbonamento di prova premium. Vuoi iscriverti?',
			'profileScreen.yes' => 'Sì',
			'profileScreen.no' => 'No',
			...
			'parentalGate.wrongAnswer' => 'Risposta sbagliata. Per favore riprova.',
