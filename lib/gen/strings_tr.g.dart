...
class _TranslationsParentalGateTr implements TranslationsParentalGateEn {
	...
	// Translations
	@override String get title => 'Sadece Ebeveynler İçin';
	@override String get subtitle => 'Devam etmek için lütfen aşağıdaki matematik problemini çözün:';
	@override String get hint => 'Cevap';
	@override String get incorrect => 'Yanlış cevap, lütfen tekrar deneyin.';
}
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'parentalGate.title' => 'Sadece Ebeveynler İçin',
			'parentalGate.subtitle' => 'Devam etmek için lütfen aşağıdaki matematik problemini çözün:',
			'parentalGate.hint' => 'Cevap',
			'parentalGate.incorrect' => 'Yanlış cevap, lütfen tekrar deneyin.',
			_ => null,
		};
	}
}
