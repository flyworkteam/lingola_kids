...
class _TranslationsTermOfServicePrivacyPolicyTr implements TranslationsTermOfServicePrivacyPolicyEn {
	...
	@override String get section3Body => 'Verileriniz öğrenme ilerlemesini izlemek, kelime içeriğini kişiselleştirmek ve teknik sorunları gidermek için işlenir. Kişisel bilgiler asla ticari kullanım amacıyla üçüncü şahıslara satılmaz veya paylaşılmaz. Güvenilir servis sağlayıcılar (bulut depolama, kimlik doğrulama ve abonelik yönetimi) verileri kesinlikle gizlilik yükümlülükleri altında işler.';
...
class _TranslationsTermOfServiceCookiePolicyTr implements TranslationsTermOfServiceCookiePolicyEn {
	...
	@override String get lastUpdated => 'Son Güncelleme: 2026';
	@override String get intro => 'Lingola Kids\'e hoş geldiniz. Dijital yardımcı teknolojiler, yapay zeka video görüşme deneyiminizi daha sorunsuz, daha güvenli ve kişiselleştirilmiş hale getirmek için kullanılır.';
	...
	@override String get section4Body => 'Bazı teknolojiler teknik hizmet sağlayıcıları tarafından sağlanabilir ve kendi politikalarına tabidir. Lingola Kids, bu ortaklıklarda veri güvenliğine öncelik verir.';
...
class _TranslationsOnboardingStep5Tr implements TranslationsOnboardingStep5En {
	...
	@override String get permission1Subtitle => 'Lingola Kids, AI karakterleriyle görüntülü aramalar için kameranızı kullanır.';
	@override String get permission2 => 'Mikrofon Erişimi';
	@override String get permission2Subtitle => 'Lingola Kids, sesli ve görüntülü aramalar için mikrofonunuzu kullanır.';
	@override String get permission3 => 'Konum Erişimi';
	@override String get permission3Subtitle => 'Lingola Kids deneyiminizi kişiselleştirmek için konumunuzu kullanır.';
}
...
class _TranslationsDeleteAccountStepsStep1Tr implements TranslationsDeleteAccountStepsStep1En {
	...
	@override String get subtitle => 'Lingola Kids deneyimini geliştirebilmemiz için neden ayrılmak istediğinizi bize söyleyebilir misiniz?';
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'termOfService.cookiePolicy.intro' => 'Lingola Kids\'e hoş geldiniz. Dijital yardımcı teknolojiler, yapay zeka video görüşme deneyiminizi daha sorunsuz, daha güvenli ve kişiselleştirilmiş hale getirmek için kullanılır.',
			...
			'termOfService.cookiePolicy.section4Body' => 'Bazı teknolojiler teknik hizmet sağlayıcıları tarafından sağlanabilir ve kendi politikalarına tabidir. Lingola Kids, bu ortaklıklarda veri güvenliğine öncelik verir.',
			...
			'onboarding.step5.permission1Subtitle' => 'Lingola Kids, AI karakterleriyle görüntülü aramalar için kameranızı kullanır.',
			'onboarding.step5.permission2' => 'Mikrofon Erişimi',
			'onboarding.step5.permission2Subtitle' => 'Lingola Kids, sesli ve görüntülü aramalar için mikrofonunuzu kullanır.',
			'onboarding.step5.permission3' => 'Konum Erişimi',
			'onboarding.step5.permission3Subtitle' => 'Lingola Kids deneyiminizi kişiselleştirmek için konumunuzu kullanır.',
			...
			'deleteAccount.steps.step1.subtitle' => 'Lingola Kids deneyimini geliştirebilmemiz için neden ayrılmak istediğinizi bize söyleyebilir misiniz?',
