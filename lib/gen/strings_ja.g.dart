...
class _TranslationsParentalGateJa implements TranslationsParentalGateEn {
	...
	// Translations
	@override String get title => '保護者のみ';
	@override String get subtitle => '続けるには、次の計算問題を解いてください：';
	@override String get hint => '答え';
	@override String get incorrect => '間違った答えです。もう一度お試しください。';
}
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'parentalGate.title' => '保護者のみ',
			'parentalGate.subtitle' => '続けるには、次の計算問題を解いてください：',
			'parentalGate.hint' => '答え',
			'parentalGate.incorrect' => '間違った答えです。もう一度お試しください。',
			_ => null,
		};
	}
}
