...
class _TranslationsParentalGateEs implements TranslationsParentalGateEn {
	...
	// Translations
	@override String get title => 'Solo para padres';
	@override String get subtitle => 'Por favor, resuelve el siguiente problema matemático para continuar:';
	@override String get hint => 'Respuesta';
	@override String get incorrect => 'Respuesta incorrecta, inténtalo de nuevo.';
}
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'parentalGate.title' => 'Solo para padres',
			'parentalGate.subtitle' => 'Por favor, resuelve el siguiente problema matemático para continuar:',
			'parentalGate.hint' => 'Respuesta',
			'parentalGate.incorrect' => 'Respuesta incorrecta, inténtalo de nuevo.',
			_ => null,
		};
	}
}
