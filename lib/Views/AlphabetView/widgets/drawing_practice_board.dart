...
class DrawingPracticeBoardState extends State<DrawingPracticeBoard> {
  ...
  Future<bool> evaluate() async {
    ...
    final groupGate = groupCoverages.every((coverage) => coverage >= 0.68);
    ...
    final targetGate =
        groupGate && componentGate && cellCoverage >= 0.80 && coverage >= 0.74;
    final strokeGate =
        drawnCloseRatio >= 0.68 &&
        offTrackRatio <= 0.18 &&
        averageDistance <= tolerance * 1.30;
    ...
    Print.info(
      ...
      'groupGate=$groupGate componentGate=$componentGate strokeGate=$strokeGate '
